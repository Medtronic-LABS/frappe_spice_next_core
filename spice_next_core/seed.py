"""Seed dummy data for spice_next_core development testing."""
...
def bump_sync_seqs():
	...
	for dt in _SYNCABLE:
		try:
			...
			for name in names:
				# Portable atomic increment -- see hooks_impl.advance_sync_seq for why
				# this isn't a single RETURNING statement (MariaDB doesn't support
				# UPDATE...RETURNING, only INSERT/DELETE).
