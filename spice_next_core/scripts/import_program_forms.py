...
Run via bench:
  bench execute spice_next_core.scripts.import_program_forms.run
...
def run(source_json=None, fixtures_dir=None):
    ...
    fixtures_dir: path to spice_next_core/fixtures/ (default: auto-locate)
    """
    base = os.path.dirname(os.path.abspath(__file__))
    app_root = os.path.join(base, "..", "..")   # spice_next_core/
    ...
    if fixtures_dir is None:
        fixtures_dir = os.path.normpath(os.path.join(app_root, "spice_next_core", "fixtures"))
