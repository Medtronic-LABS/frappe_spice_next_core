...
from spice_next_core.ai.case_narrative import _build_context as _build_case_context
from spice_next_core.ai.facility_narrative import _build_facility_context
from spice_next_core.ai.household_narrative import _build_household_context
from spice_next_core.ai.patient_narrative import _build_patient_context
...
def ask_ai_stream(doctype, docname, question, history="[]"):
	...
	frappe.enqueue(
		"spice_next_core.ai.chat._run_response",
		doctype=doctype,
		docname=docname,
		question=question,
